...
h1 = Air(name='Karl', nickname='Invoker', hp=780, damage=60)
h2 = Space(name='Pudge', nickname='Butcher', hp=800, damage=90)
h3 = Earthly(name='Gustavo', nickname='Gus', hp=1000, damage=200)
h1.brand_phrase()